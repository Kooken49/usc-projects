...
<body class="text-gray-800 font-georgia">
  <div class="flex">
    <!-- Fixed Sidebar -->
    <aside class="w-64 h-screen fixed top-0 left-0 bg-[#f1f1f1] shadow-lg p-6 flex flex-col justify-between">
      <div>
        ...
        datesSet: function () {
          document.querySelectorAll('.fc-daygrid-day').forEach(cell => {
            cell.classList.add(
              ...
              'hover:bg-blue-100', 'cursor-pointer', 'rounded', 'hover:shadow-md', 'hover:scale-105'
            );
          });
        }
      });
