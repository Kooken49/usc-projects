...
<div class="flex-1 bg-white flex flex-col min-h-screen">
  ...
  <main class="flex flex-1 overflow-hidden h-[calc(100vh-6rem)]">
    
    <!-- Calendar -->
    <div class="flex-1 p-6 overflow-auto">
      <div id="calendar" class="bg-[#f1f1f1] rounded-lg shadow p-4 h-full"></div>
    </div>
  ...
  <!-- ======================== Notifications ======================== -->
  <section class="p-6 border-t bg-gray-50 max-h-60 overflow-y-auto">
      ...
      function applyHoverStyles() {
        document.querySelectorAll('.fc-daygrid-day').forEach(cell => {
          cell.classList.add(
            ...
            'hover:bg-blue-100', 'cursor-pointer', 'rounded',
